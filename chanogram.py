...
- attracts more than *{1} replies per minute*,
- has at least *{2} total replies* and
- does not have the following keyword{3} in the subject: *{4}* _(since those threads usually aren't related to breaking news but attract lots of replies per minute because of regular posters)._
